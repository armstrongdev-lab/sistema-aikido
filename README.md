# Sistema de Gestão de Alunos de Aikido
...
- Sistema de graduação de faixas
- Controle de mensalidades (pago, em aberto, ausente)
...
![Dashboard](imagens/dashboard.jpeg)
![Agenda](imagens/cadastro.jpeg)
